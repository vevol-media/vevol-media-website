const generalQuestions = [
    ...
    },
    {
        ...
        text: `While we have collaborated with businesses across various industries over the years, our work portfolio focuses mainly on eCommerce shops, tech companies, vineyards, supplement shops, fashion stores and others.`
    },
    {
        id: 3,
        title: ` Do you offer hosting services?`,
        text: `All the Shopify stores we build come with a free hosting package. For other platforms such as WordPress, we can recommend you a trusty provider`
    },
    {
        id: 4,
    ...
    },
    {
        ...
        text: `Yes. You can count on us to take care of your website for a small monthly fee of only €99. `
    }
]
