...
export const query = graphql`
	query DispotradingImagesRo {
		images: allFile(filter: { relativeDirectory: { eq: "apps-case-studies/dispotrading" } }) {
			nodes {
				name
				childImageSharp {
...
export default function DispotradingPage({ data }) {
	const app = appsPortfolio.ro.find((a) => a.internalUrl === '/ro/proiecte/aplicatii-shopify/dispotrading');
