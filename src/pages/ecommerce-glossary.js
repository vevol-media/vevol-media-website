...
export default function EcommerceGlossaryPage({data}) {
	...
	return (
		<Layout>
					...
					<ImageWithText
						...
						textContent={[
							...
							<p className="mt-5">
								...
								That's why we've compiled a comprehensive glossary of 100 essential terms that will help
								demystify the world of eCommerce and Shopify, empowering you to make informed decisions
								and optimise your online business.
							</p>,
							<p className="mt-5">
								That's why we've compiled a comprehensive glossary of 100 essential terms that will help
								demystify the world of eCommerce and Shopify, empowering you to make informed decisions
			...
			<VevolSection backgroundColour={'white'}>
				<Container>
					<p className="mt-5">By familiarising yourself with these key eCommerce and Shopify terms, you'll be equipped with the knowledge to navigate the intricate landscape of online business. Whether you're a seasoned entrepreneur or just starting your eCommerce journey, understanding these concepts will enable you to communicate effectively, make informed decisions, and utilise the full potential of Shopify's features.</p>
					<p className='mt-5'>Remember, the world of eCommerce is constantly evolving, and staying informed is key. Embrace these terminologies as the building blocks of your eCommerce vocabulary, and stay ahead in the competitive marketplace.</p>
					<p className='mt-5'>Ready to take your eCommerce business to new heights? Explore the power of Shopify and unlock the potential of these essential terms by starting your Shopify journey today. We promise to help you along the way.</p>
				</Container>
			</VevolSection>
		</Layout>
	);
