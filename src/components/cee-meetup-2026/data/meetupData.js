...
export const mainAgenda = [
	...
	{ time: '09:20-09:35', title: 'What 1,000+ CEE Merchants Taught Us About Multichannel Growth', speaker: 'Ciprian Cazacu · Co-Founder & CEO, Easy Sales' },
	{ time: '09:40-10:10', title: 'Migration to Shopify: From Fragmentation to Unified Execution', speaker: 'David Sima · Key Account Executive, Vevol Media' },
	{ time: '10:20-10:35', title: 'How a Luxury Bundle Builder Became a Premium Commerce Experience', speaker: 'Prakhar Shrivastava · Co-founder, FoxSell Bundles' },
	{ time: '10:40-11:10', title: 'The Power of Data in eCommerce and Communication', speaker: 'Rareș Bănescu · Owner & Founder, TheMarketer' },
	{ time: '11:15-11:45', title: 'Networking break: snacks and beverages', type: 'break' },
	{ time: '11:50-12:20', title: 'Decoding the Cart: Consumer Patterns from 50K Eshop-Affiliate Partnerships', speaker: 'Ana Opriță · Deputy CEO, BusinessLeague' },
	{ time: '12:25-12:40', title: 'The Power of Less: Scaling a Global Brand with 6 People', speaker: 'Grace Radley · Senior Country Partnerships Manager, Mollie' },
	{ time: '12:40-12:50', title: 'Shopping Simplified: From Cross-border to Borderless', speaker: 'Thanasis Psychogios · Sr. Intl. BD Manager, Skroutz' },
	...
	{ time: '15:45-16:15', title: 'AI-Powered Email Automation: Smarter Journeys. Higher Profits.', speaker: 'Paul Apostu · Chief Growth Officer, Ecommerce Today' },
...
export const workshopAgenda = [
	...
	{ time: '11:30-12:45', title: 'More Revenue, Same Traffic: A Step-by-Step Guide to AI Personalization That Converts', speaker: 'Aqurate' },
...
export const sponsorTiers = [
	{
		...
		items: [{ name: 'GoKwik', url: 'https://www.gokwik.co/uk/product/kwikengage', cardStyle: { background: '#fff8e6', borderColor: '#e8c840' }, pillStyle: { color: '#7a5c00' } }],
	},
	{
		key: 'plus',
		label: 'Plus Sponsors',
		items: [
			{ name: 'BusinessLeague', url: 'https://businessleague.com/', image: businessLeagueLogo, logoColor: 'original', logoScale: 3.8, cardStyle: { background: '#f0f6ff', borderColor: '#a0c4f5' }, pillStyle: { color: '#0c447c' } },
			{ name: 'TheMarketer', url: 'https://themarketer.com/', image: theMarketerLogo, logoScale: 3.2, logoFilter: 'contrast(2.8) brightness(0.42) saturate(1.2)', cardStyle: { background: '#fff0f4', borderColor: '#f5a0bc' }, pillStyle: { color: '#8b0030' } },
			{ name: 'Mollie', url: 'https://www.mollie.com/', image: mollieLogo, logoScale: 3.3, cardStyle: { background: '#f5f0ff', borderColor: '#c4a8f5' }, pillStyle: { color: '#3b0080' } },
			{ name: 'xConnector', url: 'https://about.xconnector.app/', image: xConnectorLogo, logoScale: 3.4, logoFilter: 'contrast(2.8) brightness(0.4) saturate(1.2)', cardStyle: { background: '#f0fff8', borderColor: '#a0f0d0' }, pillStyle: { color: '#0a5e42' } },
		],
	},
	{
		key: 'bronze',
		...
		items: [
			{ name: 'FoxSell', url: 'https://foxsell.com/', image: foxSellLogo, logoScale: 3, cardStyle: { background: '#fff5e6', borderColor: '#f5c880' }, pillStyle: { color: '#7a3a00' } },
			{ name: 'Easy Sales', url: 'https://easy-sales.com/', image: easySalesLogo, logoScale: 3.45, cardStyle: { background: '#e6fff5', borderColor: '#80f5c8' }, pillStyle: { color: '#004d30' } },
			{ name: 'Videowise', url: 'https://videowise.com/', image: videoWiseLogo, logoScale: 3, cardStyle: { background: '#f0f0ff', borderColor: '#b0b0f5' }, pillStyle: { color: '#1a1a7a' } },
			{ name: 'Aqurate', url: 'https://aqurate.ai/en/', image: aquarateLogo, logoScale: 3, cardStyle: { background: '#e6f8ff', borderColor: '#80d8f5' }, pillStyle: { color: '#003d5c' } },
			{ name: 'Skroutz', url: 'https://www.skroutz.ro/', image: skroutzLogo, logoScale: 3.2, cardStyle: { background: '#fff5e6', borderColor: '#f5a880' }, pillStyle: { color: '#7a2200' } },
			{ name: 'Fulfilo', url: 'https://www.fulfilo.ro/', image: fulfiloLogo, logoScale: 3.8, logoFilter: 'contrast(2.9) brightness(0.38) saturate(1.15)', cardStyle: { background: '#f5f5f5', borderColor: '#cccccc' }, pillStyle: { color: '#333333' } },
			{ name: 'Axon', url: 'https://axon.ai/en', image: axonLogo, logoScale: 3.1, cardStyle: { background: '#f0fff0', borderColor: '#90e090' }, pillStyle: { color: '#1a4d1a' } },
			{ name: 'Klever', url: 'https://klever.agency/', image: kleverLogo, logoScale: 3.15, cardStyle: { background: '#fffae6', borderColor: '#f5e080' }, pillStyle: { color: '#5c4400' } },
			{ name: 'Consentmo', url: 'https://www.consentmo.com/', cardStyle: { background: '#f0f8ff', borderColor: '#90c8f5' }, pillStyle: { color: '#003366' } },
			{ name: 'Mejix', url: 'https://www.mejix.com/', image: mejixLogo, logoScale: 3.2, cardStyle: { background: '#fff0f8', borderColor: '#f5a0d0' }, pillStyle: { color: '#6b0040' } },
		],
	},
	{
		key: 'partners',
		...
		items: [
			{ name: 'NeuCurrent', url: 'https://neucurrent.com/', image: neuCurrentLogo, logoScale: 3.25, cardStyle: { background: '#f0f8ff', borderColor: '#90c0f0' }, pillStyle: { color: '#003366' } },
			{ name: 'Love Loyalty', url: 'https://www.loveloyalty.app/', image: loveLoyaltyLogo, logoScale: 3.35, logoFilter: 'contrast(2.7) brightness(0.42) saturate(1.2)', cardStyle: { background: '#fff0f4', borderColor: '#f5a0bc' }, pillStyle: { color: '#8b0030' } },
			{ name: 'DataRevolt', url: 'https://datarevolt.agency/ro/', image: dataRevoltLogo, logoScale: 3.25, cardStyle: { background: '#f5f0ff', borderColor: '#c4a0f5' }, pillStyle: { color: '#3b0080' } },
			{ name: 'Vevol Themes', url: 'https://vevolthemes.com/', image: vevolThemesLogo, logoScale: 3.5, logoFilter: 'contrast(2.9) brightness(0.36) saturate(1.2)', cardStyle: { background: '#f0fffa', borderColor: '#a0f5dc' }, pillStyle: { color: '#0a5e42' } },
		],
	},
];

export const editionsGallerySlots = [
